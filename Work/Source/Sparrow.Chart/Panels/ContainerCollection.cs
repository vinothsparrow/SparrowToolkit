...
namespace Sparrow.Chart
{
    ...
    /// Container Panel
    /// </summary>
    public class ContainerCollection : Canvas
    {
        ...
        protected override System.Windows.Size ArrangeOverride(System.Windows.Size arrangeSize)
        {
            foreach (UIElement child in Children)
            {
                child.Arrange(new System.Windows.Rect(new Point(0, 0), arrangeSize));
            }           
            return arrangeSize;
        }
        ...
        private void GenerateConatiners()
        {
            ...
            Binding xAxisBinding = new Binding("XAxis");
            xAxisBinding.Source = this;
            Binding yAxisBinding = new Binding("YAxis");
        ...
        public static readonly DependencyProperty RenderingModeProperty =
            DependencyProperty.Register("RenderingMode", typeof(RenderingMode), typeof(ContainerCollection), new PropertyMetadata(RenderingMode.WritableBitmap));
